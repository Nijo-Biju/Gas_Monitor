...
String apiKey = "TOR0S153P6MZFTZ6"; // Enter your Write API key from ThingSpeak
const char *ssid = "Hai"; // replace with your wifi ssid and wpa2 key
const char *pass = "nijotexas";
const char* server = "api.thingspeak.com";
DHT dht(DHTPIN,DHTTYPE);

WiFiClient client;
#define MAIN_SSID "Hai"
#define MAIN_PASS "nijotexas"
#define CSE_IP "192.168.214.193"
